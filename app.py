...
# பஞ்சாங்க அட்டவணை காட்சிப்படுத்துதல்
st.markdown(f"""
...
<p style='text-align: center; font-size: 0.73em; color: #555; margin-top: 5px;'>
    *சந்திராஷ்டம நட்சத்திரக்காரர்கள் புதிய முயற்சிகளைத் தவிர்க்கவும்.
</p>
""", unsafe_allow_html=True)
except Exception as e:
    st.error("சந்திராஷ்டமம் கணக்கிடுவதில் சிறு பிழை.")
