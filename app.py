...
districts = {
    ...
    "കടலூர்": [11.7480, 79.7714], "தர்மபுரி": [12.1271, 78.1582], "திண்டுக்கல்": [10.3673, 77.9803],
...
if "சதுர்த்தசி" in p['tithi']:
    st.markdown("<div class='special-note'>✨ இன்றைய சிறப்பு: சதுர்த்தசி - சிவபெருமான் மற்றும் பிரதோஷ வழிபாடு மிகவும் சிறப்பு.</div>", unsafe_allow_html=True)
else:
    st.markdown(f"<div class='special-note'>✨ இன்றைய வழிபாடு: {p['tithi']} திதிக்குரிய தெய்வத்தை வணங்குவது நலம் தரும்.</div>", unsafe_allow_html=True)
