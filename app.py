...
st.markdown("""
    ...
    .vrat-display-table { width:100%; border-collapse: collapse; background-color:#FFFAF0; border: 1px solid #8B0000; }
    .vrat-display-table td { padding: 12px; border-bottom: 1px solid #eee; vertical-align: middle; }
...
# ---------------- 9. விசேஷங்கள் (அட்டவணை முறையில்) ----------------
st.markdown("<div class='meroon-header'>🪷 இன்றைய விரதங்கள் & விசேஷங்கள்</div>", unsafe_allow_html=True)

# விசேஷ தரவுத்தளம் (திதி/நட்சத்திரம் அடிப்படையில்)
vrat_list = [
    # (திதி, நட்சத்திரம், மாதம், பெயர், விளக்கம்)
    ("அமாவாசை", None, "மார்கழி", "ஸ்ரீ ஹனுமன் ஜெயந்தி", "அஞ்சனை மைந்தனின் பூரண அருள் கிட்டும், பயம் நீங்கும்."),
    ("அமாவாசை", None, None, "அமாவாசை தர்ப்பணம்", "முன்னோர்களின் ஆசி கிட்டும், குடும்ப சுபிட்சம் உண்டாகும்."),
    ("பௌர்ணமி", None, None, "பௌர்ணமி விரதம்", "செல்வச் செழிப்பு மற்றும் மன அமைதி உண்டாகும்."),
    ("சதுர்த்தி", None, None, "சங்கடஹர சதுர்த்தி", "காரியத் தடைகள் நீங்கும், விநாயகர் அருள் கிட்டும்."),
    ("சஷ்டி", None, None, "சஷ்டி விரதம்", "முருகன் அருள் மற்றும் குழந்தை பாக்கியம் கிட்டும்."),
    ("திரயோதசி", None, None, "பிரதோஷம்", "சிவனருள் கிட்டும், கஷ்டங்கள் நீங்கும்."),
    ("ஏகாதசி", None, None, "ஏகாதசி விரதம்", "பெருமாள் அருள் கிட்டும், பாவங்கள் நீங்கும்."),
    (None, "கார்த்திகை", None, "கிருத்திகை விரதம்", "முருகப் பெருமானின் விசேஷ வழிபாடு."),
    (None, "திருவோணம்", None, "திருவோண விரதம்", "மகாவிஷ்ணுவின் பூரண அருள் கிட்டும்.")
]

found_v = []
for v_tithi, v_nak, v_month, v_name, v_desc in vrat_list:
    ...
    if t_match and n_match and m_match:
        found_v.append(f"<tr><td><b>✨ {v_name}</b></td><td>{v_desc}</td></tr>")

if found_v:
    # விசேஷங்களை அட்டவணையாகக் காட்டுதல்
    vrat_table_html = f"""
    <div class="main-box">
