...
def get_precise_panchang(date_obj, lat, lon):
    ...
    wara = ["திங்கட்கிழமை", "செவ்வாய்க்கிழமை", "புதன்கிழமை", "வியாழக்கிழமை", "வெள்ளிக்கிழமை", "சனிக்கிழமை", "ஞாயிற்றுக்கிழமை"][d_idx]
    
    # விசேஷங்கள்
    special_msg = "இன்று விசேஷங்கள் இல்லை"
    if t_n == 14: special_msg = "🌟 இன்று அமாவாசை / பௌர்ணமி - வழிபாடு சிறப்பு!"
    ...
    return {
        ...
        "wara": wara, "paksha": "வளர்பிறை" if t_n < 15 else "தேய்பிறை",
...
<table class="panchang-table">
    ...
    <tr><td>📅 <b>தமிழ் மாதம் & தேதி</b></td><td><b>{p['tamil']}</b> | {p['wara']} ({p['paksha']})</td></tr>
    <tr><td>🌅 <b>சூரிய உதயம் / அஸ்தமனம்</b></td><td>உதயம்: <b>{sunrise}</b> | அஸ்தமனம்: <b>{sunset}</b></td></tr>
    <tr><td>🌙 <b>திதி சஞ்சாரம்</b></td><td><b>{p['tithi']}</b><br><span class='sub-text'>முடிவு: {p['t_end']}</span></td></tr>
