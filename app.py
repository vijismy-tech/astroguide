...
# ---------- புதிய சந்திராஷ்டமம் பகுதி (இங்கே இணைக்கப்பட்டுள்ளது) ----------
st.markdown("<br><h3 style='text-align: center; color: #8B0000;'>🌙 இன்றைய சந்திராஷ்டம விவரங்கள்</h3>", unsafe_allow_html=True)
...
# தற்போதைய நட்சத்திரத்தின் இன்டெக்ஸ்-ஐ கண்டுபிடிக்கிறோம்
try:
    ...
    st.markdown(f"🚩 **தற்போதைய நிலை ({res['nak']}):**")
    st.error(f"சந்திராஷ்டமம் நட்சத்திரம்: **{naks_list[current_affected_idx]}**")
    st.write(f"நேரம்: **{res['n_e']} வரை**")
    
    st.markdown("<hr style='margin:10px 0;'>", unsafe_allow_html=True)
    
    st.markdown(f"🕒 **அடுத்து வரும் நிலை ({res['n_nx']}):**")
    st.warning(f"சந்திராஷ்டமம் நட்சத்திரம்: **{naks_list[next_affected_idx]}**")
    st.write(f"நேரம்: **{res['n_e']} முதல் தொடங்குகிறது**")
    
    st.markdown('</div>', unsafe_allow_html=True)
except Exception as e:
    st.error("சந்திராஷ்டமம் கணக்கிடுவதில் சிறு பிழை ஏற்பட்டுள்ளது.")
