...
st.markdown("""
    ...
    .planet-text { color: #000; font-weight: 600; display: block; line-height: 1.2; font-size: 0.85em; }
...
def get_all_astro_data(date_obj, lat, lon):
    ...
    return {
        ...
        "month_name": months[int(s_deg/30)%12], "transit": transit, "moon_deg": round(m_deg % 30, 2),
...
<table class="panchang-table">
    ...
    <tr><td>⭐ <b>நட்சத்திரம்</b></td><td><b>{res['nak']}</b> வரை ({res['n_e']})<br><small style='color:red'>அடுத்து: {res['n_nx']}</small></td></tr>
...
# ---------------- 9. நித்ரா காலண்டர் விரதங்கள் & விசேஷங்கள் ----------------
st.markdown("<div class='meroon-header'>🪷 இன்றைய விரதங்கள் & விசேஷங்கள்</div>", unsafe_allow_html=True)

# நித்ரா காலண்டர் அடிப்படை விரதங்கள்
vrat_db = {
    # (திதி, நட்சத்திரம், மாதம், கிழமை): [பெயர், பலன், படம்]
    ("அமாவாசை", None, None, None): ["அமாவாசை", "முன்னோர்களின் ஆசி கிட்டும்.", "https://img.freepik.com/premium-photo/hindu-ritual-called-tharpanam-ancestor-worship_1029679-65039.jpg"],
    ("பௌர்ணமி", None, None, None): ["பௌர்ணமி விரதம்", "செல்வச் செழிப்பு உண்டாகும்.", "https://img.freepik.com/free-photo/view-bright-full-moon-night-sky_23-2151000305.jpg"],
    ("சதுர்த்தி", None, None, None): ["சங்கடஹர சதுர்த்தி", "விக்னங்கள் விலகும்.", "https://img.freepik.com/premium-photo/ganesha-god-success_662214-41154.jpg"],
    ("சஷ்டி", None, None, None): ["சஷ்டி விரதம்", "முருகன் அருள் கிட்டும்.", "https://img.freepik.com/premium-photo/lord-murugan-statue-temple_950133-1463.jpg"],
    ("திரயோதசி", None, None, None): ["பிரதோஷம்", "சிவனருள் கிட்டும், கஷ்டங்கள் நீங்கும்.", "https://img.freepik.com/premium-photo/god-shiva-abstract_1029679-56602.jpg"],
    ("ஏகாதசி", None, None, None): ["ஏகாதசி விரதம்", "பெருமாள் அருள் கிட்டும்.", "https://img.freepik.com/premium-photo/god-vishnu-shiva-statue_950133-1188.jpg"],
    (None, "கார்த்திகை", None, None): ["கிருத்திகை விரதம்", "முருகன் அருள் கிட்டும்.", "https://img.freepik.com/premium-photo/lord-murugan-statue-temple_950133-1463.jpg"],
    # விசேஷங்கள்
    ("அமாவாசை", None, "மார்கழி", None): ["ஸ்ரீ ஹனுமன் ஜெயந்தி", "அஞ்சனை மைந்தனின் அருள் கிட்டும்.", "https://img.freepik.com/premium-photo/god-lord-hanuman-statue_1156453-157.jpg"],
}

found_v = False
st.markdown('<div class="main-box">', unsafe_allow_html=True)
for (t, n, m, w), d in vrat_db.items():
    t_match = (t == res['tithi'])
    n_match = (n is None or n == res['nak'])
    m_match = (m is None or m == res['month_name'])
    w_match = (w is None or w == res['wara'])

    if t_match and n_match and m_match and w_match:
        found_v = True
        st.markdown(f"""
        <table class="vrat-table">
            <tr>
                <td style="width:35%; text-align:center;"><img src="{d[2]}" width="100" height="100" style="border-radius:50%; object-fit:cover; border:2px solid #8B0000;"></td>
                <td style="padding:10px;"><b>✨ {d[0]}</b><br><small>{d[1]}</small></td>
            </tr>
        </table>
        """, unsafe_allow_html=True)
