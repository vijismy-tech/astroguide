...
def get_precise_panchang(date_obj, lat, lon):
    ...
    # தமிழ் மாதம் & தேதி கணக்கீடு (சூரியனின் பாகை அடிப்படையில்)
    tamil_months = ["சித்திரை", "வைகாசி", "ஆனி", "ஆடி", "ஆவணி", "புரட்டாசி", "ஐப்பசி", "கார்த்திகை", "மார்கழி", "தை", "மாசி", "பங்குனி"]
    # சூரியன் மேஷத்தில் (0°) நுழையும் போது சித்திரை தொடங்கும்
    t_month_idx = int(s_start / 30)
    ...
    return {
        ...
        "tamil_month": tamil_months[t_month_idx % 12], "tamil_date": t_date,
...
# தமிழ் தேதி மற்றும் மாதம் முன்னிலைப்படுத்தல்
st.markdown(f"<div class='special-note'>📅 தமிழ் தேதி: {p['tamil_month']} {p['tamil_date']} | கிழமை: {p['wara']}</div>", unsafe_allow_html=True)

st.markdown(f"""
<table class="panchang-table">
    <tr><th>அங்கம்</th><th>விவரம் ({selected_dist})</th></tr>
    <tr><td>🌙 <b>திதி சஞ்சாரம்</b></td><td>
        <b>{p['tithi']}</b> ({p['paksha']})<br>
        <span style='color: #8B0000; font-size: 0.9em;'>தமிழ் மாதம்: {p['tamil_month']} {p['tamil_date']}</span><br>
        <span class='sub-text'>முடிவு: {p['tithi_end']}</span>
    </td></tr>
