...
def get_precise_panchang(date_obj, lat, lon):
    ...
    # --- பாகை கணக்கீடு (Binary Search - 35 Iterations) ---
...
# தமிழ் மாதம் மற்றும் தேதி முன்னிலைப்படுத்தல்
st.markdown(f"<div class='special-note'>📅 {p['tamil_month']} மாதம் {p['tamil_date']} ஆம் தேதி | {p['wara']}</div>", unsafe_allow_html=True)

st.markdown(f"""
<table class="panchang-table">
    <tr><th>அங்கம்</th><th>விவரம் ({selected_dist})</th></tr>
    <tr><td>📅 <b>தமிழ் தேதி</b></td><td><b>{p['tamil_month']} {p['tamil_date']}</b></td></tr>
    <tr><td>🌙 <b>திதி & பக்கம்</b></td><td><b>{p['tithi']}</b> ({p['paksha']})<br><span class='sub-text'>முடிவு: {p['tithi_end']}</span></td></tr>
    ...
    <tr><td>✨ <b>சுப நேரங்கள்</b></td><td>நல்ல நேரம்: 10:45 AM - 11:45 AM<br>கௌரி நல்ல நேரம்: {
