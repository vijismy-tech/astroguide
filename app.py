...
ADMIN_WHATSAPP = "919876543210"  # 🔁 உங்கள் வாட்ஸ்அப் எண்ணை இங்கே மாற்றவும் (91 சேர்த்து)

# ---------- SESSION STATE (Login நிலையை பராமரிக்க) ----------
...
st.markdown("""
    ...
    .auth-container { max-width: 400px; margin: auto; padding: 20px; background: white; border-radius: 15px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); }
...
if not st.session_state.logged_in:
    ...
    with st.container():
        ...
        if mode == "Login":
            ...
            if st.button("உள்நுழை (Login)"):
                if u_name != "" and u_pass != "": # எளிய சரிபார்ப்பு
                    st.session_state.logged_in = True
                    st.rerun()
                else:
                    st.error("விவரங்களை உள்ளிடவும்!")
            ...
            if st.button("பதிவு செய்ய கோரிக்கை அனுப்புக"):
                message = f"புதிய நபர் பதிவு செய்ய விரும்புகிறார்:\nபெயர்: {s_name}\nஎண்: {s_phone}\nஊர்: {s_city}"
                whatsapp_url = f"https://wa.me/{ADMIN_WHATSAPP}?text={urllib.parse.quote(message)}"
                
                st.success("தகவல்கள் தயார்! கீழே உள்ள பட்டனை அழுத்தி வாட்ஸ்அப்பில் அனுப்பவும்.")
                st.markdown(f'''<a href="{whatsapp_url}" target="_blank">
                    ...
                    வாட்ஸ்அப்பில் விவரங்களை அனுப்பவும் (Send to WA)
                    </button></a>''', unsafe_allow_html=True)
                st.info("அனுப்பிய பிறகு நிர்வாகி அனுமதிப்பார்.")

        st.markdown('</div>', unsafe_allow_html=True)
    st.stop() # Login ஆகும் வரை பஞ்சாங்கத்தைக் காட்டாது
...
# --- இங்கிருந்து உங்கள் பழைய பஞ்சாங்க செயல்பாடுகள் தொடரும் ---
...
def get_precise_panchang(date_obj, lat, lon):
    ...
    return {
        ...
        "next_tithi": ["பிரதமை", "துவிதியை", "திருதியை", "சதுர்த்தி", "பஞ்சமி", "சஷ்டி", "சப்தமி", "அஷ்டமி", "நவமி", "தசமி", "ஏகாதசி", "துவாதசி", "திரயோதசி", "சதுர்த்தசி", "பௌர்ணமி", "பிரதமை", "துவிதியை", "திருதியை", "சதுர்த்தி", "பஞ்சமி", "சஷ்டி", "சப்தமி", "அஷ்டமி", "நவமி", "தசமி", "ஏகாதசி", "துவாதசி", "திரயோதசி", "சதுர்த்தசி", "அமாவாசை"][(t_now+1)%30],
        ...
        "next_nak": ["அஸ்வினி", "பரணி", "கார்த்திகை", "ரோகிணி", "மிருகசீரிடம்", "திருவாதிரை", "புனர்பூசம்", "பூசம்", "ஆயில்யம்", "மகம்", "பூரம்", "உத்திரம்", "அஸ்தம்", "சித்திரை", "சுவாதி", "விசாகம்", "அனுஷம்", "கேட்டை", "மூலம்", "பூராடம்", "உத்திராடம்", "திருவோணம்", "அவிட்டம்", "சதயம்", "பூரட்டாதி", "உத்திரட்டாதி", "ரேவதி"][(n_now+1)%27],
