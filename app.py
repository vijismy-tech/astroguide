...
# ---------------- 9. விசேஷங்கள் (படங்கள் இன்றி அட்டவணை மற்றும் சின்னங்களுடன்) ----------------
st.markdown("<div class='meroon-header'>🪷 இன்றைய விரதங்கள் & விசேஷங்கள்</div>", unsafe_allow_html=True)

# விசேஷ தரவுத்தளம் (சின்னங்களுடன்)
# அமைப்பு: (திதி, நட்சத்திரம், மாதம்): [சின்னம், பெயர், பலன்]
vrat_db = {
    ...
    ("சஷ்டி", None, None): ["🔱", "சஷ்டி விரதம்", "முருகன் அருள் மற்றும் வினைகள் தீரும்."],
...
# ---------------- 9. விசேஷங்கள் (சரியான அட்டவணை வடிவம்) ----------------
st.markdown("<div class='meroon-header'>🪷 இன்றைய விரதங்கள் & விசேஷங்கள்</div>", unsafe_allow_html=True)
...
found_v = False
v_html = "<table style='width:100%; border-collapse: collapse; background-color:#FFFAF0;'>"
...
for (t, n, m), d in vrat_db.items():
    ...
    if t_match and n_match and m_match:
        ...
        <tr style='border-bottom: 1px solid #ddd;'>
            <td style='font-size: 1.5em; width: 45px; text-align: center; padding: 10px;'>{d[0]}</td>
...
if found_v:
    st.markdown(f"<div class='main-box' style='padding:0;'>{v_html}</div>", unsafe_allow_html=True)
else:
